...
public class Solution 
{
    ...
    public static pair helper(BinaryTreeNode<Integer> root)
    {
        ...
        pair ans;
        int HeightDiff = lh.height > rh.height ? (lh.height-rh.height) : (rh.height-lh.height);
        if(!lh.isBalanced || !rh.isBalanced || HeightDiff > 1)
        {
            ans = new pair();
            ans.height = Math.max(lh.height,rh.height)+1;
